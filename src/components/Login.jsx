...
const Login = () => {
  ...
  const [isTermsCondition, setTermsCondition] = useState(true);
  useEffect(() => {
      ...
      <>
        <div className="alert">
          ...
          <div className="alertContent">
            Accept the Terms and Conditions to login
          </div>
        </div>
      </>
    );
        ...
        <div className="inner_login">
          ...
          <div className="login_form">
            <form action="#" className="loginForm">
              ...
              <div className="tmc">
                <label htmlFor="tmc">
                  <input type="checkbox" name="tmc" id="tnc" /> Terms &
                  Conditions
                </label>
